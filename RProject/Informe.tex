...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Mostrar generaciones disponibles}
\CommentTok{#table(dfSuicidiosFiltered$generation)}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#Agrupar por generaciones, con todas las columnas posibles. Media de HDI, media de suicides_100k_pop y media de gdp_per_capita, sexo y año}
\CommentTok{#aggregate(dfSuicidiosFiltered, by = dfSuicidiosFiltered$generation)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{#sd(dfSuicidiosFiltered$suicides_100k_pop)}
\end{Highlighting}
\end{Shaded}
